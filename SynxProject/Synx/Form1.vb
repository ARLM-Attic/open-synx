...
Public Class Home
    ...
    Private Sub SynxButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SynxButton.Click
        ...
        If ASXRButton.Checked Then
            If MusicCheckBox.Checked Then
                MessageBox.Show("Synx is about to synx all your music with your AirSynx account.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                'TODO: Check if the ASXFTPU is installed, if not install it

                'TODO: Run a Process.Start for the ASXFTPU (Videos) Executable
            End If

            If VideosCheckBox.Checked Then
                MessageBox.Show("Synx is about to synx all your videos with your AirSynx account.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                'TODO: Check if the ASXFTPU is installed, if not install it
            ...
            If PicturesCheckBox.Checked Then
                MessageBox.Show("Synx is about to synx all your pictures with your AirSynx account.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                'TODO: Check if the ASXFTPU is installed, if not install it
        ...
        If DevDrvRButton.Checked Then
            ...
            If My.Computer.FileSystem.DirectoryExists(DevDrv.Text) Then
                ...
                If MusicCheckBox.Checked Then
                    MessageBox.Show("Synx is about to synx all your music with your Android device. This may take a long time and your computer may freeze during the process depending on how much content you have.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                ...
                End If
                If VideosCheckBox.Checked Then
                    MessageBox.Show("Synx is about to synx all your videos with your Android device. This may take a long time and your computer may freeze during the process depending on how much content you have.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                ...
                If MoviesCheckBox.Checked Then
                    MessageBox.Show("Synx is about to synx all your movies with your Android device. This may take a long time and your computer may freeze during the process depending on how much content you have.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                ...
                End If
                If PicturesCheckBox.Checked Then
                    MessageBox.Show("Synx is about to synx all your pictures with your Android device. This may take a long time and your computer may freeze during the process depending on how much content you have.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub AirSynxButton_Click(sender As System.Object, e As System.EventArgs)
